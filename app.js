...
function question1() {
  ...
  if(answer1.toLowerCase() === "n" || answer1.toLowerCase() === "no") {
    ...
    resOne.textContent = 'Bingo! Lex lives with his sister, Cheri.';
    counter++;
  } else {
    //alert("BZZZT. Lex doesn't have a brother, only sisters.");
    resOne.textContent = 'BZZZT. Lex doesn\'t have a brother, only sisters.';
  }
}
...
function question2() {
  ...
  if(answer2.toLowerCase() === "n" || answer2.toLowerCase() === "no") {
    ...
    resTwo.textContent = 'You\'re right! Lex\'s cat is named Thumbles.';
    counter++;
  } else {
    //alert("No way! Murphy is his sister's dog. (Murphy doesn't exactly get along with Lex's cat.)");
    resTwo.textContent = 'No way! Murphy is his sister\'s dog. (Murphy doesn\'t exactly get along with Lex\'s cat.)';
  }
}
...
function question3() {
  ...
  if(answer3.toLowerCase() === "y" || answer3.toLowerCase() === "yes") {
    ...
    resThree.textContent = 'Yes, and sometimes with his mother as well. (When he\'s by himself he prefers \'The Blacklist\')';
    counter++;
  } else {
    //alert("Wrong. (It's her TV.)");
    resThree.textContent = 'Wrong. (It\'s her TV.)';
  }
}
